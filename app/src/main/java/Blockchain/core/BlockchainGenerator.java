...
public class BlockchainGenerator {
    ...
    /**
     * Gets the proof of work number for this {@code BlockchainGenerator}.
     *
     * This is the number of zeros for confirming proof of work for each block
     * in the blockchain generated by this {@code BlockchainGenerator}.
     *
     * @return  the proof of work number
     */
    public int getProofOfWorkNumber() {
